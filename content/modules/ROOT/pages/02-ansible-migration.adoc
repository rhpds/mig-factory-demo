...
WARNING: We need to choose a VM that has not been migrated yet. In the first module, we manually migrated the database-user1 and winweb01-user1 machines. So here, we will migrate the remaining VM: *winweb02-user1*.
...
Ansible Automation Platform has started the VM migration plan, and the *winweb02-user1* VM migration commences.
